...
<title>Services — {{ \App\Support\Settings::get('site_name') }}</title>
<meta name="description" content="Services offered by {{ \App\Support\Settings::get('site_name') }} — Laravel, Go, REST APIs, database design and deployment.">
...
.page-header-highlights{display:grid;grid-template-columns:repeat(4,auto);gap:12px;margin-top:32px;justify-content:start;}
@media(max-width:760px){.page-header-highlights{grid-template-columns:repeat(2,1fr);}}
.highlight-chip{display:flex;flex-direction:column;gap:3px;padding:14px 18px;position:relative;z-index:2;}
.highlight-chip .num{font-family:var(--f-display);font-size:22px;font-weight:600;}
.highlight-chip .lbl{font-family:var(--f-mono);font-size:10.5px;letter-spacing:1.5px;color:var(--text-dim);}
...
<nav id="nav">
  <div class="wrap row">
    ...
    <ul class="nav-links desktop-only">
      ...
      <li><a href="{{ route('services') }}" class="active-link">Services</a></li>
...
<section class="page-header">
  ...
  <div class="wrap">
    <div class="breadcrumb"><a href="{{ route('index') }}">Home</a> / Services</div>
    <h1>Services</h1>
    <p>End-to-end delivery — from schema design to a deployed, monitored production app.</p>
    <div class="page-header-highlights">
      <div class="glass highlight-chip"><span class="num">{{ $years ?? count($experience ?? []) }}+</span><span class="lbl">YEARS EXPERIENCE</span></div>
      <div class="glass highlight-chip"><span class="num">6</span><span class="lbl">SERVICES</span></div>
      <div class="glass highlight-chip"><span class="num">3</span><span class="lbl">PRICING TIERS</span></div>
      <div class="glass highlight-chip"><span class="num">Stripe</span><span class="lbl">ONLINE PAYMENT</span></div>
    </div>
  </div>
</section>
...
<section id="services">
  <div class="wrap">
    <div class="section-head" style="text-align:center;margin-left:auto;margin-right:auto;">
      ...
      <h2>Laravel Services</h2>
      <p>Expert Laravel development — from a simple brochure site to a complex, data-heavy application with payments, dashboards and third-party integrations.</p>
    </div>
    <div class="services-grid" data-aos="fade-up">
      <div class="glass service-card">
        ...
        <h3>Laravel Web Development</h3><p>Custom web applications built on Laravel 12 — clean MVC architecture, Eloquent models, validated forms, queues and caching out of the box.</p>
      </div>
      <div class="glass service-card">
        ...
        <h3>REST APIs &amp; Backend Services</h3><p>Well-documented, versioned REST APIs with Laravel Sanctum/Passport auth, API resources, rate limiting and integration-ready responses.</p>
      </div>
      <div class="glass service-card">
        <div class="icon"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/><path d="M9 22V12h6v10"/></svg></div>
        <h3>E-commerce Development</h3><p>Online stores with Laravel + MySQL, Stripe/PayPal checkout, inventory, orders, invoices and a secure admin panel to manage everything.</p>
      </div>
      <div class="glass service-card">
        <div class="icon"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><path d="M12 2a7 7 0 017 7c0 2.5-1.2 4-2.5 5.5S15 16.5 15 18v1a2 2 0 01-2 2h-2a2 2 0 01-2-2v-1c0-1.5-.8-2.5-2.5-4S5 11.5 5 9a7 7 0 017-7z"/><path d="M12 2v2"/></svg></div>
        <h3>Admin Panels &amp; Dashboards</h3><p>Custom admin dashboards with role-based access, CRUD resources, file uploads, charts and activity logs — your data, fully under your control.</p>
      </div>
      <div class="glass service-card">
        <div class="icon"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><path d="M3 3h7v7H3zM14 3h7v7h-7zM3 14h7v7H3zM14 14h7v7h-7z"/></svg></div>
        <h3>Database Design &amp; Migrations</h3><p>Relational schema design, migrations and seeders, query optimisation and indexed performance tuning for MySQL databases that grow.</p>
      </div>
      <div class="glass service-card">
        <div class="icon"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><path d="M22 12h-4l-3 9L9 3l-3 9H2"/></svg></div>
        <h3>Deployment &amp; Maintenance</h3><p>Deploy to shared hosting, VPS or Docker, configure SSL, cron jobs, backups, monitoring and ongoing Laravel upgrades and support.</p>
      </div>
    </div>
  </div>
</section>
...
<section id="pricing">
  <div class="wrap">
    <div class="section-head" style="text-align:center;margin-left:auto;margin-right:auto;">
      ...
      <p>Transparent, fixed-price packages. Pay online securely with Stripe — or let's customise a scope that fits your budget.</p>
    </div>
    <div class="pricing-grid" data-aos="fade-up">
      <div class="glass pricing-card">
        <h3>Starter</h3>
        <div class="pricing-price">$299 <small>/ project</small></div>
        <p style="color:var(--text-muted);font-size:14px;">Landing page or small brochure site.</p>
        <ul class="pricing-features">
          <li><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><path d="M20 6L9 17l-5-5"/></svg>Up to 5 pages</li>
          <li><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><path d="M20 6L9 17l-5-5"/></svg>Contact form</li>
          <li><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><path d="M20 6L9 17l-5-5"/></svg>Mobile responsive</li>
          <li><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><path d="M20 6L9 17l-5-5"/></svg>2 revisions</li>
        </ul>
        <div class="support-actions" style="flex-direction:column;">
          <button type="button" class="btn btn-primary" data-pay="card" data-amount="299" data-title="Starter Website Package">Pay with Card</button>
          <button type="button" class="btn btn-ghost" data-pay="stripe" data-amount="299" data-title="Starter Website Package">Pay with Stripe</button>
        </div>
      </div>
      <div class="glass pricing-card is-featured">
        <span class="pricing-badge">Most Popular</span>
        <h3>Professional</h3>
        <div class="pricing-price">$799 <small>/ project</small></div>
        <p style="color:var(--text-muted);font-size:14px;">Custom Laravel app or e-commerce build.</p>
        <ul class="pricing-features">
          <li><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><path d="M20 6L9 17l-5-5"/></svg>Laravel + MySQL backend</li>
          <li><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><path d="M20 6L9 17l-5-5"/></svg>Admin dashboard</li>
          <li><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><path d="M20 6L9 17l-5-5"/></svg>Secure Stripe checkout</li>
          <li><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><path d="M20 6L9 17l-5-5"/></svg>6 revisions + 30 days support</li>
        </ul>
        <div class="support-actions" style="flex-direction:column;">
          <button type="button" class="btn btn-primary" data-pay="card" data-amount="799" data-title="Professional Laravel Package">Pay with Card</button>
          <button type="button" class="btn btn-ghost" data-pay="stripe" data-amount="799" data-title="Professional Laravel Package">Pay with Stripe</button>
        </div>
      </div>
      <div class="glass pricing-card">
        <h3>Enterprise</h3>
        <div class="pricing-price">Custom <small>/ quote</small></div>
        <p style="color:var(--text-muted);font-size:14px;">Complex systems, APIs, migrations &amp; long-term support.</p>
        <ul class="pricing-features">
          <li><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><path d="M20 6L9 17l-5-5"/></svg>Architecture &amp; code review</li>
          <li><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><path d="M20 6L9 17l-5-5"/></svg>REST APIs &amp; integrations</li>
          <li><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><path d="M20 6L9 17l-5-5"/></svg>Deployment &amp; monitoring</li>
          <li><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><path d="M20 6L9 17l-5-5"/></svg>SLA &amp; ongoing maintenance</li>
        </ul>
        <a href="{{ route('contact') }}" class="btn btn-primary" style="width:100%;">Get a Quote</a>
      </div>
    </div>
  </div>
</section>
...
if(phEl){
  const ph = (s)=>phEl.querySelector(s);
  const phBreadcrumb = ph('.breadcrumb'), phH1 = ph('h1'), phP = ph('p'), phChips = phEl.querySelectorAll('.highlight-chip');
  if(phBreadcrumb) gsap.from(phBreadcrumb, {y:16, opacity:0, duration:.6, delay:.7, ease:'power3.out'});
  ...
  if(phChips.length) gsap.from(phChips, {y:18, opacity:0, duration:.6, delay:1.1, stagger:.08, ease:'power3.out'});
}
...
// ---- Stripe inline payment (Payment Element) ----
(function(){
  ...
  document.querySelectorAll('#pricing [data-pay="card"]').forEach(btn=>{
    btn.addEventListener('click', ()=>{
      const title = btn.getAttribute('data-title') || 'Development Package';
      const usd = parseFloat(btn.getAttribute('data-amount')) || 299;
      ...
      fetch('{{ route('payment.stripe.intent') }}', {
        ...
        body: JSON.stringify({amount: usd, title: title})
      })
...
// ---- Stripe Checkout redirect (pricing cards) ----
document.querySelectorAll('#pricing [data-pay="stripe"]').forEach(btn=>{
  btn.addEventListener('click', ()=>{
    btn.disabled = true;
    ...
    .then(res=>{
      ...
      else { alert(res.d.error || 'Payment could not be started.'); }
    })
    .catch(()=>{ btn.disabled = false; btn.textContent = 'Pay with Stripe'; alert('Network error. Please try again.'); });
  });
});
