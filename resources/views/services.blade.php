...
<title>Services — Muhammad Bin Imran</title>
<meta name="description" content="Services offered by Muhammad Bin Imran — Laravel, Go, REST APIs, database design and deployment.">
...
<section id="services">
  <div class="wrap">
    <div class="section-head" style="text-align:center;margin-left:auto;margin-right:auto;" data-aos="fade-up">
    ...
    <div class="pricing-grid" data-aos="fade-up">
      <div class="glass pricing-card">
        ...
        <div class="support-actions" style="flex-direction:column;">
          <button type="button" class="btn btn-primary" data-pay="stripe" data-amount="299" data-title="Starter Website Package">Pay with Stripe</button>
        </div>
      </div>
      <div class="glass pricing-card is-featured">
        ...
        <div class="support-actions" style="flex-direction:column;">
          <button type="button" class="btn btn-primary" data-pay="stripe" data-amount="799" data-title="Professional Laravel Package">Pay with Stripe</button>
        </div>
      </div>
      <div class="glass pricing-card">
        <h3>Enterprise</h3>
...
<div id="stripeModal" class="stripe-modal">
  <div class="stripe-modal-card glass">
    ...
    <h3 class="stripe-modal-title" id="stripeModalTitle">Pay with Stripe</h3>
