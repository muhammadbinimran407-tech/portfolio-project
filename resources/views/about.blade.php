...
<nav id="nav">
  <div class="wrap row">
    ...
    <ul class="nav-links desktop-only">
      ...
      <li><a href="{{ route('about') }}" class="active-link">About</a></li>
...
<section class="page-header">
  ...
  <div class="wrap">
    <div class="breadcrumb"><a href="{{ route('index') }}">Home</a> / About</div>
    <h1>About Me</h1>
    <p>Who I am, how I got here, and the numbers behind the work.</p>
  </div>
</section>
...
<section id="about" style="padding-top:20px;">
  <div class="wrap about-grid">
    ...
    <div class="about-bio" data-aos="fade-left">
      <p>I'm Muhammad Bin Imran, a full stack web developer focused on building fast, dependable products end to end — from database schema to the pixels a user actually touches. My core toolkit is Laravel and Go, backed by clean REST APIs and MySQL, with Tailwind and vanilla JavaScript on the front end.</p>
      <p>I care about software that stays fast and stays up: sensible architecture, tested code paths, and infrastructure that doesn't need babysitting. Outside of client work, I spend time contributing on GitHub and sharpening the Go side of my stack.</p>
      <div class="stack-panel" style="margin-top:8px;">
        <div class="stack-panel-head"><span>education.log</span><span>2019 — 2023</span></div>
        <div style="padding:18px 22px;font-size:14.5px;color:var(--text-muted);">BS Computer Science — data structures, systems design, and networks.</div>
      </div>
...
<section id="journey">
  <div class="wrap">
    <div class="section-head">
      <span class="eyebrow">./journey.log</span>
...
<nav class="bottom-nav">
  <a href="{{ route('index') }}" class="bn-item">
      ...
      <a href="{{ route('about') }}" class="bn-item active">
